...
public class ProgressBarWebView extends WebView {
    ...
    private void init(final Context context) {
        ...
        dialogView.setMax(100);
//        dialogView.setIndeterminate(true);
        dialogView.setProgressDrawable(getResources().getDrawable(R.drawable.progressbar));
    ...
    final class MyWebChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            dialogView.setProgress(newProgress);
        }
