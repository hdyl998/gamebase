...
public class SaveData {
    ...
    private final static String KEY_NAME = "gamedata1";
...
//	}
    ...
    public static SaveData getInstance() {
        if (instance == null) {
            String string = ShareCacheUtil.getString(App.getContext(), KEY_NAME);
            if (string != null)
    ...
    public static void saveSetting() {
        ...
        ShareCacheUtil.putString(App.getContext(), KEY_NAME, JSON.toJSONString(instance));
    }
